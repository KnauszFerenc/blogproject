    ...
    <div class="flex flex-row flex-nowrap">
        ...
        <section class="flex-grow">
            ...
            <div class="p-10 flex flex-row justify-between">
                <a href="{{ route('admin') }}/back_entry/posteditor/?post_id=newpost">Új hozzáadása</a>
                <input type="text" placeholder="Felhasználó neve...">
            </div>
            <div class="p-10">
                @php
                ...
                @foreach($posts as $post)
                    <div class="border-y border-cyan-500 flex flex-row flex-wrap py-3 items-center">
                        ...
                        <a class="mx-3" target="_blank" href="{{ route('admin') }}/back_entry/posteditor/?post_id={{ $post->ID }}">Szerkeszt</a>
                        <button>Töröl</button>
                    </div>
                @endforeach
            </div>
