            ...
            <div class="p-10">
                <div class="w-2/5 rounded-xl shadow-md p-2">
                    ...
                    @foreach($posts as $post)
                        ...
                        @endphp
                    @endforeach
                    <p class="mt-3 rounded-3xl bg-cyan-500 hover:bg-cyan-600 text-center px-4 py-2 text-white w-fit"><a href="{{ route('admin') }}/posteditor/?post_id=new&&post_type=post">Új hozzáadása</a></p>
                </div>
            </div>
        </section>
    </div>
